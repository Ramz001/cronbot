...
export type GetAutomationRunAggregateType<
	T extends AutomationRunAggregateArgs,
> = {
...
> = {
	...
	orderBy?:
		...
		| Prisma.AutomationRunOrderByWithAggregationInput[];
	by:
		| Prisma.AutomationRunScalarFieldEnum[]
		| Prisma.AutomationRunScalarFieldEnum;
	...
	Prisma.PrismaPromise<
		Array<
			Prisma.PickEnumerable<AutomationRunGroupByOutputType, T["by"]> & {
				[P in keyof T &
					keyof AutomationRunGroupByOutputType]: P extends "_count"
					? T[P] extends boolean
						? number
...
export type AutomationRunWhereInput = {
	...
	status?:
		| Prisma.EnumAutomationRunStatusFilter<"AutomationRun">
		| $Enums.AutomationRunStatus;
	triggeredBy?: Prisma.StringNullableFilter<"AutomationRun"> | string | null;
	scheduledAt?:
		| Prisma.DateTimeNullableFilter<"AutomationRun">
		| Date
		| string
		| null;
	startedAt?:
	...
	automation?: Prisma.XOR<
		Prisma.AutomationScalarRelationFilter,
...
export type AutomationRunScalarWhereWithAggregatesInput = {
	...
	status?:
		...
		| $Enums.AutomationRunStatus;
	triggeredBy?:
		| Prisma.StringNullableWithAggregatesFilter<"AutomationRun">
		| string
		| null;
	scheduledAt?:
		| Prisma.DateTimeNullableWithAggregatesFilter<"AutomationRun">
		| Date
		| string
		| null;
	startedAt?:
	...
	finishedAt?:
		...
		| null;
	durationMs?:
		| Prisma.IntNullableWithAggregatesFilter<"AutomationRun">
		| number
		| null;
	...
	createdAt?:
		| Prisma.DateTimeWithAggregatesFilter<"AutomationRun">
		| Date
		| string;
	updatedAt?:
		| Prisma.DateTimeWithAggregatesFilter<"AutomationRun">
...
export type AutomationRunUpdateInput = {
	...
	status?:
		| Prisma.EnumAutomationRunStatusFieldUpdateOperationsInput
		| $Enums.AutomationRunStatus;
...
export type AutomationRunCreateNestedManyWithoutAutomationInput = {
	...
	connect?:
		| Prisma.AutomationRunWhereUniqueInput
		| Prisma.AutomationRunWhereUniqueInput[];
};
...
export type AutomationRunUpdateManyWithoutAutomationNestedInput = {
	...
	updateMany?:
		...
		| Prisma.AutomationRunUpdateManyWithWhereWithoutAutomationInput[];
	deleteMany?:
		| Prisma.AutomationRunScalarWhereInput
		| Prisma.AutomationRunScalarWhereInput[];
};
...
> {
	...
	createManyAndReturn<T extends AutomationRunCreateManyAndReturnArgs>(
		args?: Prisma.SelectSubset<
			T,
			AutomationRunCreateManyAndReturnArgs<ExtArgs>
		>,
	): Prisma.PrismaPromise<
		runtime.Types.Result.GetResult<
			Prisma.$AutomationRunPayload<ExtArgs>,
		...
		T extends runtime.Types.Utils.Record<"select", any>
			? T["select"] extends true
				...
				: Prisma.GetScalarType<
						T["select"],
						AutomationRunCountAggregateOutputType
					>
			: number
	>;
	...
	>(
		args: Prisma.SubsetIntersection<T, AutomationRunGroupByArgs, OrderByArg> &
			InputErrors,
	): {} extends InputErrors
		? GetAutomationRunGroupByPayload<T>
...
> = {
	 ...
	 */
	data: Prisma.XOR<
		Prisma.AutomationRunCreateInput,
		Prisma.AutomationRunUncheckedCreateInput
	>;
};
...
> = {
	 ...
	 */
	data:
		| Prisma.AutomationRunCreateManyInput
		| Prisma.AutomationRunCreateManyInput[];
	skipDuplicates?: boolean;
};
...
> = {
	...
	data: Prisma.XOR<
		...
		Prisma.AutomationRunUncheckedUpdateInput
	>;
	/**
